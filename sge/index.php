...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['salvar_emprestimo'])) {
    ...
    $stmt = $pdo->prepare("INSERT INTO emprestimos (data, documento, item, nome, status, retirada_com, devolvido_com, data_devolucao) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$data, $documento, $item, $nome, $status, $retirada_com, $devolvido_com, $data_devolucao]);
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="index.php" method="post">
                    <div class="row g-3">
                        <div class="col-md-6"><input type="date" class="form-control" name="data" placeholder="Data" required></div>
                        ...
                        <div class="col-md-6"><input type="date" class="form-control" name="data_devolucao" placeholder="Data Devolução"></div>
                    </div>
