...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $_SESSION['form_feedback'] = ['status' => 'success', 'message' => 'Funcionário atualizado com sucesso!'];
    } catch (PDOException $e) {
        $_SESSION['form_feedback'] = ['status' => 'error', 'message' => 'Erro ao atualizar funcionário.'];
    }
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="setor" id="setor" class="form-select" required>
                        <option value="GERÊNCIA" <?= $funcionario['setor'] == 'GERÊNCIA' ? 'selected' : '' ?>>GERÊNCIA</option>
                        <option value="NTI" <?= $funcionario['setor'] == 'NTI' ? 'selected' : '' ?>>NTI</option>
                        <option value="INFRAESTRUTURA" <?= $funcionario['setor'] == 'INFRAESTRUTURA' ? 'selected' : '' ?>>INFRAESTRUTURA</option>
                        <option value="SERVIÇOS" <?= $funcionario['setor'] == 'SERVIÇOS' ? 'selected' : '' ?>>SERVIÇOS</option>
                        <option value="COMUNICAÇÃO" <?= $funcionario['setor'] == 'COMUNICAÇÃO' ? 'selected' : '' ?>>COMUNICAÇÃO</option>
                        <option value="ADMINISTRATIVO" <?= $funcionario['setor'] == 'ADMINISTRATIVO' ? 'selected' : '' ?>>ADMINISTRATIVO</option>
                    </select>
                </div>
                <div class="col-md-6">
