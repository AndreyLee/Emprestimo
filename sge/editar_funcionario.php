            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="setor" id="setor" class="form-select" required>
                        ...
                        <option value="Financeiro" <?= $funcionario['setor'] == 'Financeiro' ? 'selected' : '' ?>>Financeiro</option>
                        <option value="RH" <?= $funcionario['setor'] == 'RH' ? 'selected' : '' ?>>RH</option>
                        <option value="TI" <?= $funcionario['setor'] == 'TI' ? 'selected' : '' ?>>TI</option>
                    </select>
                </div>
                <div class="col-md-6">
