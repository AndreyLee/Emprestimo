...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['cadastrar_funcionario'])) {
    ...
    if (empty($nome) || empty($senha) || empty($setor) || empty($perfil)) {
        $_SESSION['form_feedback'] = ['status' => 'error', 'message' => 'Todos os campos são obrigatórios.'];
    } else {
        ...
        if ($stmt->execute([$nome, $senha_hash, $setor, $perfil])) {
            $_SESSION['form_feedback'] = ['status' => 'success', 'message' => 'Funcionário cadastrado com sucesso!'];
        } else {
            $_SESSION['form_feedback'] = ['status' => 'error', 'message' => 'Erro ao cadastrar funcionário.'];
        }
    }
                        ...
                        <?php foreach ($funcionarios as $funcionario): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="excluir-form d-inline" action="excluir_funcionario.php" method="post">
